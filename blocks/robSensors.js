...
Blockly.Blocks['robSensors_encoder_reset'] = {
    ...
    init: function() {
        ...
        if (this.workspace.device === 'orb'){
            motorport = new Blockly.FieldDropdown([['M1', 'M1'], ['M2', 'S2'], ['M3', 'M3'], ['M4', 'M4']]);
        }
...
Blockly.Blocks['robSensors_gyro_reset'] = {
    init: function() {
        ...
        if (this.workspace.device === 'orb'){
            sensorPort = new Blockly.FieldDropdown([['S1', 'S1'], ['S2', 'S2'], ['S3', 'S3'], ['S4', 'S4']]);
        }
...
Blockly.Blocks['robSensors_timer_reset'] = {
    ...
    init: function() {
        this.setColour(Blockly.CAT_SENSOR_RGB);
        var sensorNum;
        if (this.workspace.device === 'nxt' || this.workspace.device === 'botnroll' || this.workspace.device === 'bob3' || this.workspace.device === 'wedo' || this.workspace.device === 'orb') {
